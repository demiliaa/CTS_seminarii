package ro.ase.csie.cts.g1088.laborator3.faza1.faza2;
...
public class Produs {
	...
	public static void validareVecimeClient(int vechimeClientInAni) throws ExceptieVechimeClient{
	...
	public float getPretFinal(TipProdus tipProdus, float pretInitial, int vechimeClientInAni) throws ExceptiePretInvalid, ExceptieVechimeClient 
	  {
		...
		validareVecimeClient(vechimeClientInAni);
